...
def patch_file(filepath, outpath, replacements):
...
patch_file('./src/components/AdminDirectory.tsx', './src/components/AdminDirectory2.tsx', dir_reps)
...
patch_file('./src/components/AdminAnnouncements.tsx', './src/components/AdminAnnouncements2.tsx', ann_reps)
...
# The last replace failed on CRLF vs LF. Let's do it individually as a string replace.
...
patch_file('./src/components/AdminDocumentUpload.tsx', './src/components/AdminDocumentUpload2.tsx', up_reps[:-1])
patch_file_raw('./src/components/AdminDocumentUpload2.tsx', './src/components/AdminDocumentUpload2.tsx', up_reps[-1][0], up_reps[-1][1])
